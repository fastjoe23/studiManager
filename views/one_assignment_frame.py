...
class OneAssignmentWindow(tk.Toplevel):
    def __init__(self, parent, assignment=None, student=None, *args, **kwargs):
        ...
        reviewer_names = [", ".join([lecturer.last_name, lecturer.first_name]) for lecturer in all_lecturers if lecturer.is_reviewer]
        self.lecturer_combobox['values'] = sorted(reviewer_names)
